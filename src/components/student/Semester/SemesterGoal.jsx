...
//                   <td
//                     key={field}
//                     onClick={() => setEditCell({ rowIndex: index, field })}
//                   >
//                     {editCell.rowIndex === index && editCell.field === field ? (
//                       field === "course" ? (
//                         <select
//                           value={goal[field]}
//                           onChange={(e) => handleInlineChange(e, index, field)}
//                           onBlur={() => saveInlineEdit(goal, index)}
//                           autoFocus
//                         >
...
//                           onBlur={() => saveInlineEdit(goal, index)}
//                           onKeyDown={(e) => {
//                             if (e.key === "Enter") saveInlineEdit(goal, index);
//                           }}
//                           autoFocus
//                         />
//                       )
...
//                 <td
//                   onClick={() =>
//                     setEditCell({ rowIndex: index, field: "dueDate" })
//                   }
//                 >
...
//                       type="date"
//                       value={goal.dueDate}
//                       onChange={(e) => handleInlineChange(e, index, "dueDate")}
//                       onBlur={() => saveInlineEdit(goal, index)}
//                       onKeyDown={(e) => {
//                         if (e.key === "Enter") saveInlineEdit(goal, index);
//                       }}
              ...
              <tr key={goal.id || index}>
                {["course", "goals", "courseExpectations", "teacherExpectations", "selfExpectations", "dueDate"].map((field) => (
                  <EditGoal
                    ...
                    field={field}
                    rowIndex={index}
                    isEditing={editCell.rowIndex === index && editCell.field === field}
                    onStartEdit={(rowIndex, field) => setEditCell({ rowIndex, field })}
                ...
                <td>
                  <div className="action-buttons">
                    <button
                      ...
                      title="View time"
                    >
                      <i className="fa-regular fa-clock" style={{ color: "#00BFFF" }}></i>
                    </button>
                    <button
                      className="action-btn delete-btn"
                      onClick={async () => {
                      ...
                      title="Delete"
                    >
                      <i className="fa-solid fa-trash" style={{ color: "#FF4D4F" }}></i>
                    </button>
                  </div>
                </td>
              </tr>
