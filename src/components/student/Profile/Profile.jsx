...
import PersonalInfo from "./PersonalInfo";
import AccountSettings from "./AccountSettings";
import { updateAvatarStudent } from "../../../services/api/StudentAPI";
import {
  FaCamera,
  FaBolt,
  FaBook,
...
const Profile = () => {
  ...
  const [studentData, setStudentData] = useState({
    ...
    achievements: "3",
    avatar:
      "https://scontent.fdad3-6.fna.fbcdn.net/v/t39.30808-1/491788778_649590807968338_7283296483705890060_n.jpg?...",
    activities: [
      {
        title: "Hoàn thành bài tập",
        subtitle: "Lập trình Web",
  ...
  const handleAvatarChange = async (e) => {
    ...
    try {
      const newAvatarUrl = await updateAvatarStudent(file);
      ...
      <div className="profile-header">
        ...
        <div className="header-content">
          <div className="profile-main-info">
            ...
            <div className="basic-info">
              <div className="name-section">
                <h1 className="student-name" style={{ color: "white" }}>
                  {studentData.name}
                </h1>
                <span className="status-badge">Đang học</span>
              </div>
      ...
      {activeTab === "overview" && (
        <div className="main-content-content">
          <div className="content-left">
            <div className="activity-section">
              <h3 className="section-title">
                <span className="title-icon">⚡</span>Hoạt động gần đây
              </h3>
              <div className="activity-list">
                {studentData.activities.map((activity, index) => (
                  <div key={index} className="activity-item">
              ...
              <div className="progress-content">
                ...
                <div className="progress-bar">
                  <div
                    className="progress-fill"
                    style={{
                      width: `${studentData.progress.completed}%`,
                    }}
                  ></div>
                </div>
              </div>
